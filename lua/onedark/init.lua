...
if vim.diagnostic then
  ...
  h('LspDiagnosticsVirtualTextError',     { fg = red })
  h('LspDiagnosticsVirtualTextWarning',   { fg = yellow })
  h('LspDiagnosticsVirtualTextInformation', { fg = blue })
  h('LspDiagnosticsVirtualTextHint',      { fg = cyan })
end

-- Neovim Treesitter colors
h('@variable',          { fg = red })
h('@constructor.lua',       { fg = blue })
